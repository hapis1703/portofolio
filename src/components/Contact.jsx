    ...
    >
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <h3
              className={`text-xl font-bold mb-6 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
            >
              Send a Message
            </h3>
            <form
              onSubmit={handleSubmit}
              className={`rounded-2xl p-6 border backdrop-blur-md ${theme === "dark" ? "bg-slate-800/30 border-slate-700" : "bg-white/60 border-slate-200"}`}
            >
            ...
            <div className={`space-y-4 mb-8`}>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p
                      className={`text-xs font-medium uppercase tracking-wide mb-1 ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}
                    >
                      Email
                    </p>
                    <a
                      href="mailto:hepiss1703@gmail.com"
                      className={`font-medium ${theme === "dark" ? "text-white hover:text-cyan-300" : "text-slate-900 hover:text-cyan-600"} transition`}
                    >
      ...
      <footer
        className={`mt-20 pt-8 border-t text-center ${theme === "dark" ? "border-slate-800" : "border-slate-200"}`}
      >
        <p
          className={`${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}
        >
